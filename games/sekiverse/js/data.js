const GAME_DATA_PT = {
    loreText: `22:00h. O turno acabou. Você se joga na cama, sentindo o peso de mais um dia exaustivo de trabalho. O sono vem rápido, mas o despertar é estranho. Você não está em casa.\n\nVocê acorda em uma sala apertada; à sua frente, um painel cobre a parede de ponta a ponta e, acima dele, um cronômetro digital marca 05:30 em vermelho neon.\n\nO jogo começou.`,
    timerSeconds: 330,
    areas: [
        {
            ...
            questions: [
                { question: "Qual é o próximo número na sequência: 2, 4, 6, 8, ?", options: ["9", "10", "12", "11"], correct: 1, explanation: "A sequência aumenta de 2 em 2. Logo, 8 + 2 = 10." },
                { question: "Se todos os gatos são animais, e Rex é um gato, o que podemos afirmar?", options: ["Rex é uma planta", "Rex é um animal", "Todos os animais são gatos", "Rex não é um animal"], correct: 1, explanation: "Se todos os gatos são animais e Rex é um gato, então Rex é um animal." },
                ...
                { question: "Se um lápis custa R$2 e uma borracha custa R$3, quanto custam 2 lápis e 1 borracha?", options: ["R$5", "R$7", "R$8", "R$6"], correct: 1, explanation: "2 lápis = R$4, 1 borracha = R$3. Total = R$7." }
            ],
            miniGame: { type: "simon", title: "Sequência de Memória", description: "Observe a sequência de cores e repita na ordem correta.", sequenceLength: 4, colors: ["#ff0033", "#00aaff", "#00ff88", "#ffcc00"] }
        },
        {
            id: 2, name: "Corredor dos Espelhos", subtitle: "Reflexos infinitos distorcem sua imagem. Nada é o que parece.", theme: "area-mirrors", explorerHint: "Uma rachadura no espelho brilha estranhamente...",
            questions: [
                { question: "Se 3x + 7 = 22, qual o valor de x?", options: ["3", "5", "7", "4"], correct: 1, explanation: "3x = 22 - 7 = 15, logo x = 5." },
                { question: "Se 2(x − 3) = 10, então x é igual a:", options: ["5", "8", "6", "7"], correct: 1, explanation: "2x − 6 = 10 → 2x = 16 → x = 8." },
                { question: "Um número somado com seu dobro resulta em 45. Qual é esse número?", options: ["20", "15", "22", "18"], correct: 1, explanation: "x + 2x = 45 → 3x = 45 → x = 15." },
                { question: "Se x + 5 = 12, qual o valor de x?", options: ["5", "6", "7", "8"], correct: 2, explanation: "x = 12 − 5 = 7." }
            ],
            miniGame: { type: "unscramble", title: "Espelho de Palavras", description: "As letras estão embaralhadas pelo reflexo. Forme a palavra correta.", word: "REFLEXO", hint: "Algo que todo espelho mostra." }
        },
        {
            id: 3, name: "Sala das Engrenagens", subtitle: "Engrenagens rangem. Vapor escapa das paredes de bronze.", theme: "area-steampunk", explorerHint: "Uma engrenagem solta treme no chão...",
            questions: [
                { question: "Qual dia vem depois de terça-feira?", options: ["Segunda", "Quarta", "Quinta", "Domingo"], correct: 1, explanation: "Depois de terça vem quarta-feira." },
                { question: "Se A > B e B > C, quem é o maior?", options: ["B", "C", "A", "Todos iguais"], correct: 2, explanation: "A é maior que B, que é maior que C. Logo A é o maior." },
                { question: "Uma pizza foi dividida em 8 fatias. Você comeu 3 e seu amigo comeu 2. Quantas sobraram?", options: ["2", "4", "3", "5"], correct: 2, explanation: "8 − 3 − 2 = 3 fatias sobraram." },
                { question: "Quantos meses do ano têm 31 dias?", options: ["5", "6", "7", "8"], correct: 2, explanation: "Jan, Mar, Mai, Jul, Ago, Out, Dez = 7 meses com 31 dias." }
            ],
            miniGame: { type: "lock", title: "Cofre de Engrenagens", description: "Decifre a combinação do cofre usando as pistas.", answer: [3, 7], clues: ["A soma dos dois dígitos é 10.", "O primeiro dígito é ímpar e menor que 5."] }
        },
        {
            id: 4, name: "Laboratório Digital", subtitle: "Código verde cai pelas paredes como chuva. Você é dado.", theme: "area-matrix", explorerHint: "Um terminal esquecido exibe um prompt piscando...",
            questions: [
                { question: "Quanto é 1010 em binário convertido para decimal?", options: ["8", "10", "12", "5"], correct: 1, explanation: "1×8 + 0×4 + 1×2 + 0×1 = 10." },
                { question: "Quantos bits existem em 1 byte?", options: ["4", "8", "16", "32"], correct: 1, explanation: "1 byte = 8 bits." },
                { question: "Qual linguagem é mais usada para criar sites?", options: ["Python", "Java", "HTML", "C++"], correct: 2, explanation: "HTML é a linguagem base de toda página web." },
            ...
            miniGame: { type: "cipher", title: "Decodificador", description: "Ajuste o deslocamento para decifrar a mensagem secreta.", encoded: "IXJD", decoded: "FUGA", correctShift: 3, hint: "A resposta é uma palavra que significa escapar." }
        },
        {
            id: 5, name: "O Vazio", subtitle: "Tudo desaparece. A realidade treme. Só resta... isto.", theme: "area-void", explorerHint: "Um fragmento de realidade flutua à deriva...",
            questions: [
                { question: "Ao jogar uma moeda, qual a chance de cair cara?", options: ["25%", "50%", "75%", "100%"], correct: 1, explanation: "Uma moeda tem dois lados, então a chance é 50%." },
                { question: "Qual o resultado de 100 ÷ 4?", options: ["20", "25", "30", "50"], correct: 1, explanation: "100 dividido por 4 = 25." },
                { question: "Qual planeta do sistema solar é conhecido como 'planeta vermelho'?", options: ["Júpiter", "Vênus", "Marte", "Saturno"], correct: 2, explanation: "Marte é conhecido pela sua cor avermelhada." },
                { question: "Se você virar uma luva direita do avesso, ela servirá para qual mão?", options: ["Direita", "Esquerda", "Ambas", "Nenhuma"], correct: 1, explanation: "Ao virar do avesso, a luva espelha." }
            ],
    ...
    badges: [
        { id: "despertar", name: "Despertar", icon: "🌅", description: "Complete a Área 1 — Sala do Despertar." },
        { id: "reflexo", name: "Reflexo", icon: "🪞", description: "Complete a Área 2 — Corredor dos Espelhos." },
        { id: "mecanico", name: "Mecânico", icon: "⚙️", description: "Complete a Área 3 — Sala das Engrenagens." },
        { id: "hacker", name: "Hacker", icon: "💻", description: "Complete a Área 4 — Laboratório Digital." },
        { id: "voidwalker", name: "Voidwalker", icon: "🕳️", description: "Complete a Área 5 — O Vazio." },
        { id: "speedrunner", name: "Speedrunner", icon: "⚡", description: "Complete o jogo com mais de 1 minuto sobrando." },
        { id: "perfeccionista", name: "Perfeccionista", icon: "💎", description: "Termine o jogo errando no máximo 4 perguntas." },
        { id: "meio_caminho", name: "Meio Caminho", icon: "🛤️", description: "Complete 3 áreas." },
    ...
    endings: {
        trueEnd: { id: "true", title: "TRUE END", text: "O cenário se dissolve em pixels. O ar pesado do escritório some e você desperta em uma planície verde infinita.\n\nUma casa solitária range ao vento logo à frente.\n\nAo girar a maçaneta...\n\n▸ To be continued.", theme: "ending-true" },
        limbo: { id: "limbo", title: "LIMBO", text: "Você cruzou a linha de chegada, mas o vazio ainda te persegue.\n\nVocê está em um espaço branco infinito com uma placa:\n\n\"Tente novamente. Não deixe segredos para trás.\"", theme: "ending-limbo" },
        backrooms: { id: "backrooms", title: "THE BACKROOMS", text: "O cronômetro zera. O zumbido das luzes fluorescentes aumenta até ficar insuportável.\n\nVocê está em um labirinto de paredes amarelas e carpete úmido.\n\nO tempo acabou aqui, mas algo acabou de começar ali na frente...", theme: "ending-backrooms" }
    },
    areaCompleteText: [
        "A porta se abre com um estalo. O neon morre atrás de você.",
        "Os espelhos racham em uníssono. O caminho se revela.",
        "As engrenagens param. O silêncio é ensurdecedor.",
        "O código para de cair. Uma saída se materializa.",
        "O vazio te aceita. Você está livre... ou nem tanto."
    ],
    secondPlayLoreText: `22:00h. O turno acabou. Você se joga na cama, sentindo o peso de mais um dia exaustivo de trabalho. O sono vem rápido, mas o despertar é estranho. Você não está em casa.\n\nVocê acorda em uma sala apertada; à sua frente, um painel cobre a parede de ponta a ponta e, acima dele, um cronômetro digital marca 05:30 em vermelho neon.\n\nVocê lembra do que eu disse, né? Tente zerar dessa vez sem deixar nada pra trás.....`,
    funnyMessages: [
        "Dica: respire fundo. Ou não, tanto faz.",
        "Sabia que um polvo tem 3 corações? Agora sabe.",
        "Loading... piada engraçada... ERROR 404",
        "Você já piscou 47 vezes desde que começou.",
        "Se você errar, eu não vou te julgar. Mentira, vou sim.",
        "Plot twist: o jogo joga você.",
        "O cronômetro tá correndo. Eu também estaria.",
        "Fato inútil: bananas são tecnicamente berries.",
        "Parabéns! Você achou uma mensagem secreta! ...ou não.",
        "O dev desse jogo tá orgulhoso de você. Provavelmente.",
        "Não, não tem como pausar. Boa sorte.",
        "Você sabia que flamingos podem beber água fervente? Bizarro."
    ],
    optionsConfig: [
        { key: "skipIntro", label: "⏭️ Pular Intro", type: "toggle", useful: true, desc: "Pula o texto de introdução — muito útil pra quem já viu" },
        { key: "pizzaMode", label: "🍕 Modo Pizza", type: "toggle", useful: false, desc: "Transforma o cursor em uma pizza. Por que não?" },
        { key: "rotation", label: "🔄 Girar Tela", type: "slider", min: 0, max: 360, useful: false, desc: "Gira a tela inteira. Totalmente desnecessário." },
        { key: "partyMode", label: "🎉 Modo Festa", type: "toggle", useful: false, desc: "CONFETE INFINITO PRA SEMPRE!!!" },
        { key: "silenceVolume", label: "🔊 Volume do Silêncio", type: "slider", min: 0, max: 100, useful: false, desc: "Controla o volume do som que não existe" }
    ]
};
